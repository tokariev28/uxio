...
**Agent 0** scrapes the input URL with `["markdown", "screenshot"]` and stores the result in `ctx.inputPageData`. Agent 3 reuses this cached data — avoiding a duplicate Firecrawl call for the input URL.
